...
//         const q = query(projectsCollectionRef, where("domain", "==", domain));
...
//           // Additional data fetching logic (if needed) goes here
...
//     // Fetch projects for the selected domain
//     if (domain) {
//       fetchProjects();
//     }
//   }, [domain]);
...
//       const db = getFirestore();
//       const branchDocRef = doc(db, "btech", domain, "year", "IV"); // Update this query based on your data structure
...
//     // Fetch sections for the selected domain
//     if (domain) {
//       fetchSections();
//     }
//   }, [domain]);
...
//       const db = getFirestore();
//       const projectsCollectionRef = collection(db, "projects");
//       const q = query(projectsCollectionRef, where("branch", "==", domain));
//       const querySnapshot = await getDocs(q);
